...
function validateUser(user, pass) {
    for (let i = 0; i < usuarios.length; i++) {
      if (usuarios[i].username == user) {
        ...
        if (usuarios[i].password == pass) {
          ...
          document.getElementById("signOffButton").style.display = "flex";
  ...
  /* Constructor y metodo para agregar nuevos usuarios */

  class Usuario {
    constructor(name, username, email, phone, pass) {
    ...
    static agregarUsuario() {
      let usuario = new Usuario(document.registerUser.name.value, document.registerUser.user.value, document.registerUser.email.value, document.registerUser.phone.value, document.registerUser.password.value);
